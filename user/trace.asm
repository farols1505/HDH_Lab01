...
int main(int argc, char *argv[]) {
  ...
  18:	4509                	li	a0,2
  1a:	6b8000ef          	jal	6d2 <fprintf>
        exit(1);
  1e:	4505                	li	a0,1
  20:	2b4000ef          	jal	2d4 <exit>
  24:	e426                	sd	s1,8(sp)
  26:	84ae                	mv	s1,a1
    }
  ...
  28:	6588                	ld	a0,8(a1)
  2a:	1b4000ef          	jal	1de <atoi>
    
    if (trace(mask) < 0) {
  2e:	346000ef          	jal	374 <trace>
  ...
  3a:	6888                	ld	a0,16(s1)
  3c:	2d0000ef          	jal	30c <exec>
    
    fprintf(2, "trace: exec failed for %s\n", argv[2]);
  40:	6890                	ld	a2,16(s1)
  42:	00001597          	auipc	a1,0x1
  46:	8be58593          	addi	a1,a1,-1858 # 900 <malloc+0x150>
  4a:	4509                	li	a0,2
  4c:	686000ef          	jal	6d2 <fprintf>
    exit(1);
  50:	4505                	li	a0,1
  52:	282000ef          	jal	2d4 <exit>
        fprintf(2, "trace: failed to enable tracing\n");
  56:	00001597          	auipc	a1,0x1
  5a:	88258593          	addi	a1,a1,-1918 # 8d8 <malloc+0x128>
  5e:	4509                	li	a0,2
  60:	672000ef          	jal	6d2 <fprintf>
        exit(1);
  64:	4505                	li	a0,1
  66:	26e000ef          	jal	2d4 <exit>
...
gets(char *buf, int max)
{
 ...
 15a:	0344d663          	bge	s1,s4,186 <gets+0x52>
    cc = read(0, &c, 1);
 15e:	4605                	li	a2,1
 160:	faf40593          	addi	a1,s0,-81
 164:	4501                	li	a0,0
 166:	186000ef          	jal	2ec <read>
    if(cc < 1)
 16a:	00a05e63          	blez	a0,186 <gets+0x52>
    buf[i++] = c;
 16e:	faf44783          	lbu	a5,-81(s0)
 172:	00f90023          	sb	a5,0(s2)
    if(c == '\n' || c == '\r')
 176:	01578763          	beq	a5,s5,184 <gets+0x50>
 17a:	0905                	addi	s2,s2,1
 17c:	fd679de3          	bne	a5,s6,156 <gets+0x22>
    buf[i++] = c;
 180:	89a6                	mv	s3,s1
 182:	a011                	j	186 <gets+0x52>
 184:	89a6                	mv	s3,s1
      break;
  }
  buf[i] = '\0';
...
stat(const char *n, struct stat *st)
{
 ...
 1bc:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1be:	85ca                	mv	a1,s2
 1c0:	16c000ef          	jal	32c <fstat>
 1c4:	892a                	mv	s2,a0
  close(fd);
 1c6:	8526                	mv	a0,s1
 1c8:	134000ef          	jal	2fc <close>
  return r;
 1cc:	64a2                	ld	s1,8(sp)
}
 1ce:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c4:	56850513          	addi	a0,a0,1384 # 928 <digits>
 3c8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 65a:	2d2b8b93          	addi	s7,s7,722 # 928 <digits>
 ...
 6a8:	27c90913          	addi	s2,s2,636 # 920 <malloc+0x170>
        for(; *s; s++)
